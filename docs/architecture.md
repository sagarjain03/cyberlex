...
| **lenis** | Smooth scrolling | The single highest-perceived-quality change per KB on a long scrolling page. Bypassed entirely under `prefers-reduced-motion`. | Phase 0 ✅ |
